...
// GANTI: CloudUpload → UploadCloud
// GANTI: FileAudio → FileMusic (atau tetap FileAudio jika ada)
...
const UploadZone = ({ onFileSelect }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* GANTI DI SINI: CloudUpload → UploadCloud */}
      ...
      <p className="text-white/50 mb-4">or click to select file from device</p>
